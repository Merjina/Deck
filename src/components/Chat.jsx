...
const Chat = () => {
  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get("https://deckbackend-production.up.railway.app/api/messages/all", {
        headers: {
  ...
  const handleReviewSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://deckbackend-production.up.railway.app/api/messages/submit",
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`
